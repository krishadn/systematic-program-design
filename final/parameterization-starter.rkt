...
(check-expect (contains? "Other" (cons "McGill" (cons "UBC" empty))) false)
...
;; produce list of the result of fn applied on every element in the list
(check-expect (map2 sqr empty) empty)
(check-expect (map2 sqr (list 3 4)) (list 9 16))
(check-expect (map2 sqrt (list 9 16)) (list 3 4))
(check-expect (map2 number->string (list 9 16)) (list "9" "16"))
(check-expect (map2 string->number (list "9" "16")) (list 9 16))
...
;; produce list of elements from lon whose result for fn is true
...
(check-expect (filter2 false? (list true true false false)) (list false false))
